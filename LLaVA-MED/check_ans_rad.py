...
from dataloader import RadDataset
import re
from transformers import AutoTokenizer

output_file = 'recycle_bin/acc/rad_vdz_2l3.txt'
...
print(f'[blue]\[acc][/blue]: {(closed_right_count + opened_right_count) / total_count}')
print(f'[blue]\[closed][/blue]: {closed_right_count / closed_count}')
print(f'[blue]\[opened][/blue]: {opened_right_count / open_count}')
print(f'[blue]\[opened_word_recall][/blue]: {opened_p_rgt_count / open_count}')